...
describe("Image", () => {
  ...
  describe("Attribute handling", () => {
    ...
    it("should not set alt attribute when not provided", () => {
      nostoImage = (<nosto-image src={shopifyUrl} width={300} height={200} />) as Image
      nostoImage.connectedCallback()

      const imgElement = nostoImage.querySelector("img")
      expect(imgElement).toBeDefined()
      expect(imgElement!.hasAttribute("alt")).toBe(false)
    })

    it("should not set alt attribute when undefined", () => {
      nostoImage = (<nosto-image src={shopifyUrl} width={300} height={200} alt={undefined} />) as Image
      nostoImage.connectedCallback()
    ...
    it("should handle custom sizes overriding unpic-generated sizes", () => {
      const customSizes = "(min-width: 1024px) 33vw, 100vw"
      nostoImage = (
        <nosto-image src={shopifyUrl} width={600} height={400} layout="constrained" sizes={customSizes} />
      ) as Image
      nostoImage.connectedCallback()

      const imgElement = nostoImage.querySelector("img")
      expect(imgElement).toBeDefined()
      expect(imgElement!.getAttribute("sizes")).toBe(customSizes)
    })
  })
})
