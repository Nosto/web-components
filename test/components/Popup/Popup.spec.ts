...
describe("Popup", () => {
  ...
  describe("Basic functionality", () => {
    it("should render shadow content with dialog and ribbon slots", async () => {
      const popup = element`<nosto-popup name="test-popup"
    ...
    it("should be visible by default", async () => {
      const popup = element`<nosto-popup name="test-popup"><div slot="default">Content</div></nosto-popup>` as Popup
  ...
  describe("Named popups and persistence", () => {
    it("should hide popup if it was previously closed and name is set", async () => {
      ...
      const popup = element`<nosto-popup name="${popupName}"><div slot="default">Content</div></nosto-popup>` as Popup
    ...
    it("should show popup if name is set but not previously closed", async () => {
      const popup = element`<nosto-popup name="new-popup"><div slot="default">Content</div></nosto-popup>` as Popup
    ...
    it("should throw error when name attribute is missing", async () => {
      const popup = element`<nosto-popup><div slot="default">Content</div></nosto-popup>` as Popup
  ...
  describe("Segment-based activation", () => {
    it("should show popup when user has matching segment", async () => {
      ...
      const popup =
        element`<nosto-popup name="test-popup" segment="target-segment"><div slot="default">Content</div></nosto-popup>` as Popup
    ...
    it("should hide popup when user does not have matching segment", async () => {
      ...
      const popup = element`<nosto-popup name="test-popup" segment="non-matching-segment"
    ...
    it("should propagate segment API errors", async () => {
      ...
      const popup =
        element`<nosto-popup name="test-popup" segment="any-segment"><div slot="default">Content</div></nosto-popup>` as Popup
  ...
  describe("Click handling and closing", () => {
    it("should close popup when element with n-close attribute is clicked", async () => {
      const popup = element`<nosto-popup name="closeable-popup"
          ><div slot="default">
    ...
    it("should store closed state in localStorage when popup has name", async () => {
      ...
      const popup = element`<nosto-popup name="${popupName}"
          ><div slot="default">
            <button n-close>Close</button>
          </div></nosto-popup
        >` as Popup
    ...
    it("should always store closed state in localStorage since name is required", async () => {
      const popup = element`<nosto-popup name="always-stores-popup"
          ><div slot="default">
            <button n-close>Close</button>
          </div></nosto-popup
        >` as Popup
    ...
    it("should handle click events on ribbon content with n-close", async () => {
      const popup = element`<nosto-popup name="ribbon-popup"
          ><div slot="default">Dialog content</div>
          <div slot="ribbon">
  ...
  describe("Combined scenarios", () => {
    it("should respect both segment and closed state conditions", async () => {
      ...
      const popup = element`<nosto-popup name="${popupName}" segment="matching-segment"
          ><div slot="default">Content</div></nosto-popup
        >` as Popup
    ...
    it("should hide popup when segment doesn't match, even without closed state", async () => {
      ...
      const popup = element`<nosto-popup name="new-segment-popup" segment="required-segment"
          ><div slot="default">Content</div></nosto-popup
        >` as Popup
  ...
  describe("Ribbon mode functionality", () => {
    it("should switch to ribbon mode when n-ribbon element is clicked", async () => {
      const popup = element`<nosto-popup name="ribbon-test-popup"
          ><div slot="default">
    ...
    it("should prevent default and stop propagation on n-ribbon click", async () => {
      const popup = element`<nosto-popup name="ribbon-events-popup"
          ><div slot="default">
