...
describe("VariantSelector - Compact Mode", () => {
  ...
  it("should render a dropdown in compact mode", async () => {
    ...
    const selector = element<VariantSelector>`<nosto-variant-selector handle="variant-test-product" mode="compact"></nosto-variant-selector>`
  ...
  it("should preselect first available variant in compact mode when preselect is true", async () => {
    ...
    const selector = element<VariantSelector>`<nosto-variant-selector handle="variant-test-product" mode="compact" preselect></nosto-variant-selector>`
    await selector.connectedCallback()
  ...
  it("should not render dropdown if product has only one variant in compact mode", async () => {
    ...
    const selector = element<VariantSelector>`<nosto-variant-selector handle="single-variant-product" mode="compact"></nosto-variant-selector>`
    await selector.connectedCallback()
  ...
  it("should skip single-value options in compact mode dropdown titles", async () => {
    ...
    const selector = element<VariantSelector>`<nosto-variant-selector handle="single-value-test" mode="compact"></nosto-variant-selector>`
    await selector.connectedCallback()
  ...
  it("should disable dropdown when all variants are unavailable", async () => {
    ...
    const selector = element<VariantSelector>`<nosto-variant-selector handle="all-unavailable-product" mode="compact"></nosto-variant-selector>`
    await selector.connectedCallback()
  ...
  it("should enable dropdown when at least one variant is available", async () => {
    ...
    const selector = element<VariantSelector>`<nosto-variant-selector handle="one-available-product" mode="compact"></nosto-variant-selector>`
    await selector.connectedCallback()
  ...
  it("should sort variants by first option value order", async () => {
    ...
    const selector = element<VariantSelector>`<nosto-variant-selector handle="unordered-variant-product" mode="compact"></nosto-variant-selector>`
    await selector.connectedCallback()
