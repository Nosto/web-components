...
describe("shadowContentFactory", () => {
  ...
  describe("edge cases", () => {
    it("should handle empty styles", async () => {
      const styles = ""
      const content = "<p>Content with no styles</p>"
    ...
    it("should handle complex CSS styles", async () => {
      const styles = `
      ...
      `
      const content = '<button class="button">Click me</button>'
    ...
    it("should handle special HTML characters in content", async () => {
      ...
      const content = '<p>Test &lt;div&gt; &amp; "quotes"</p>'
