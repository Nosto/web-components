...
function createDemoProduct(
  ...
  return (
    <nosto-product product-id={productId} reco-id="storybook-demo">
      ...
      <div class="product-price" n-price>
        {price}
      </div>
      {skuContent}
      ...
      <>
        ...
        <div class="sku-options-group">
          ...
          <nosto-sku-options name="sizes">
            <span n-option n-skus="123,223" class="size-option">
              L
            </span>
            <span n-option n-skus="234,334" class="size-option">
              M
            </span>
            <span n-option n-skus="145,245,345" class="size-option">
              S
            </span>
          </nosto-sku-options>
        </div>
    ...
    const skuContent = (
      <>
        <div class="sku-options-group">
          <div class="sku-group-label">Color</div>
          <nosto-sku-options name="colors">
            <span n-option n-skus="123" n-skus-oos="145" title="L,S,Cotton,Silk,Wool">
              Black
            </span>
            <span n-option n-skus="223,245" n-skus-oos="234" title="L,M,S,Cotton,Silk,Wool">
              White
            </span>
            <span n-option n-skus="334,345" title="M,S,Cotton,Silk">
              Blue
            </span>
          </nosto-sku-options>
        </div>
        ...
        <div class="sku-options-group">
          ...
          <nosto-sku-options name="materials">
            <span n-option n-skus="123,345" n-skus-oos="234" title="Black,White,Blue,L,M,S">
              Cotton
            </span>
            <span n-option n-skus="223,334" n-skus-oos="145" title="Black,White,Blue,L,M,S">
              Silk
            </span>
            <span n-option n-skus="245" title="White,S">
              Wool
            </span>
          </nosto-sku-options>
        </div>
  ...
  render: () => {
    const skuContent = (
      <div class="sku-options-group">
        <div class="sku-group-label">Color</div>
        <nosto-sku-options name="colors">
          <span n-option n-skus="100" class="color-option black" title="Black">
            Black
          </span>
          <span n-option n-skus="200" class="color-option white" title="White" selected>
            White
          </span>
          <span n-option n-skus="300" class="color-option blue" title="Blue">
            Blue
          </span>
          <span n-option n-skus="400" class="color-option red" title="Red">
            Red
          </span>
          <span n-option n-skus="500" class="color-option green" title="Green">
            Green
          </span>
        </nosto-sku-options>
      </div>
    ...
    const skuContent = (
      <>
        <div class="sku-options-group">
          <div class="sku-group-label">Size</div>
          <nosto-sku-options name="sizes">
            <span n-option n-skus="watch-38" n-price="$199.99" class="size-option" selected>
              38mm
            </span>
            <span n-option n-skus="watch-42" n-price="$249.99" class="size-option">
              42mm
            </span>
            <span n-option n-skus="watch-46" n-price="$299.99" class="size-option">
              46mm
            </span>
          </nosto-sku-options>
        </div>
