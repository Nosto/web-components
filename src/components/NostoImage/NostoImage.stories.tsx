...
import { NostoImage } from './NostoImage'
...
const sampleImages = [
  {
    ...
    imageUrl: "https://cdn11.bigcommerce.com/s-hm8pjhul3k/products/4055/images/23603/7-15297__04892.1719977920.1280.1280.jpg",
  },
  {
...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'NostoImage is a custom element that renders responsive images with support for Shopify and BigCommerce image transformations.',
      },
    },
  },
  argTypes: {
...
export const AllLayouts: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Complete showcase of all image layouts and configurations, converted from the images template in dev folder. Use the tabs to switch between different layout modes.',
      },
    },
  },
}