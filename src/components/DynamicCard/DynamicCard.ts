 ...
 * @attribute {string} section - The section to use for rendering the product. section or template is required.
 * @attribute {string} template - The template to use for rendering the product. section or template is required.
 * @attribute {string} [variant-id] - The variant ID to fetch specific variant data. Optional.
 * @attribute {boolean} [placeholder] - If true, the component will display placeholder content while loading. Defaults to false.
 * @attribute {boolean} [lazy] - If true, the component will only fetch data when it comes into view. Defaults to false.
 *
 * @example
 *  ```html
