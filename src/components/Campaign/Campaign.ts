 ...
 *
 * @attribute {string} placement (or id) - The placement identifier for the campaign.
 * @attribute {string} product-id - The ID of the product to associate with
 * the campaign.
 * @attribute {string} [variant-id] - The variant ID of the product.
 * @attribute {string} template - The ID of the template to use for rendering
 * the campaign. If provided, the campaign will be rendered using this template.
 * @attribute {string} [init] - If set to "false", the component will not
 * automatically load the campaign on connection. Defaults to "true".
 * @attribute {boolean} [lazy] - If true, the component will only load the campaign
 * when it comes into view using IntersectionObserver. Defaults to false.
 * @attribute {boolean} [cart-synced] - If true, the component will reload the campaign
